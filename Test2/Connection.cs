...
namespace Test2
{
    class Connection
    {
        public static string MyConnectionString ="Server=localhost;Database=baza;port=3306;Uid=root;Pwd=password;SslMode=none"; // "Server=localhost;Database=nowabazadanych;port=3306;Uid=root;Pwd=password;SslMode=none"; 
